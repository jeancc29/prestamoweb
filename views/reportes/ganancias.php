                                ...
                                <form method="post" >
                                    ...
                                    <div class="row ">
                                        <div class="form-group col-4">
                                            <input ng-click="reportes_ganancias()" class="btn btn-primary btn-block" type="submit" name="generar" value="Generar">
                                        </div>
                                    </div>
                                </form>
                          ...
                          <div class="box-body table-responsive no-padding">
                              <table class="table table-hover">
                                  ...
                                  <tr class="editar-iconos" ng-repeat="p in reporte">
                                      ...
                                      <td>{{p.ano}}</td>
                                      <td>{{p.nombre_mes}}</td>
                                      <td>{{p.cantidad_prestamos}}</td>
                                      <td>{{p.total_prestado  | currency}}</td>
                                      <td>{{p.total_pagado  | currency}}</td>
