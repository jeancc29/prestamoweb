<div class="content-wrapper" ng-app="myModuleClientes">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <a href="<?php echo ROOT_PATH; ?>clientes/agregar" class="btn btn-primary ml-3">Nuevo</a>
                                    <div class="box-tools">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <tr class="editar-iconos" ng-repeat="c in clientes">
                                            ...
                                            <td>{{c.correo}}</td>
                                            <td>
                                                <a href="<?php echo ROOT_PATH; ?>clientes/agregar/{{c.codigo_usuario}}" class="ion-edit d-inline bg-primary py-1 px-2 text-white rounded"></a>
